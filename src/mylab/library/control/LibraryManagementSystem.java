...
public class LibraryManagementSystem {
	...
	public static void main(String[] args) {
		...
		testFindBook(library);          // 2. 검색 테스트 호출
	    testCheckOut(library);          // 3. 대출 테스트 호출
	    testReturn(library);            // 4. 반납 테스트 호출
	    displayAvailableBooks(library); // 5. 대출 가능 목록 출력 호출
	}
	//샘플 도서 추가, 도서관 정보 출력
	...
	public static void testFindBook(Library library) {
		...
		Book title = library.findBookByTitle("자바의 정석");
